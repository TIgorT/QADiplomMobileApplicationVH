...
public class LoveIsAllElement {
    ...
    public ViewInteraction aCheckmarkButton = onView(withId(R.id.our_mission_item_list_recycler_view));
    ...
    public ViewInteraction descriptionOfTheQuote = onView(
            allOf(withId(R.id.our_mission_item_description_text_view),
                    ...
                    isDisplayed()));
    public ViewInteraction theDescriptionOfTheQuoteIsHidden = onView(
            allOf(withId(R.id.our_mission_item_description_text_view),
                    withText("\"Ну, идеальное устройство мира в моих глазах. Где никто не оценивает, никто не осудит, где говоришь, и тебя слышат, где, если страшно, тебя обнимут и возьмут за руку, а если холодно тебя согреют.” Юля Капис, волонтер"),
                    withParent(withParent(withId(R.id.our_mission_item_material_card_view))),
                    not(isDisplayed())));
